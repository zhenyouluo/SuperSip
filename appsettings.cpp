...
{
  AppSettings::httpSettings->setValue("port", 8080);
  AppSettings::httpSettings->setValue("minThreads", 1);
  AppSettings::httpSettings->setValue("maxThreads", 1);
  ...
  AppSettings::sessionSettings->setValue("cookieDomain", "mydomain.com"); //TODO
